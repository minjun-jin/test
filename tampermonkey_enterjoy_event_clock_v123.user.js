...
// @updateURL    https://raw.githubusercontent.com/minjun-jin/test/refs/heads/main/tampermonkey_enterjoy_event_clock_v123.user.js
// @downloadURL  https://raw.githubusercontent.com/minjun-jin/test/refs/heads/main/tampermonkey_enterjoy_event_clock_v123.user.js
// @version      1.23
...
(function () {
    ...
    function createClockDisplay() {
        ...
        if (document.getElementById(clockDisplayId)) {
            clockDisplay = document.getElementById(clockDisplayId);
            return;
        }
    ...
    function updateClock(timestamp) {
        ...
        if (USE_24HCLOCK) {
            ...
            currentTimeString = `${hours24}:${minutes}:${seconds}`;
        } else {
            ...
            currentTimeString = `${hours}:${minutes}:${seconds} ${meridiem}`;
        }

        // Only update DOM if the time string has actually changed
        if (clockDisplay && lastRenderedTimeString !== currentTimeString) {
            clockDisplay.textContent = currentTimeString;
            lastRenderedTimeString = currentTimeString;
        }
    }
