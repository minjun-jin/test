...
/////// 데이터소스정보추가 /////////////////////////////////////////////////////
		if (dataSource instanceof HikariDataSource hikariDataSource) {
			...
			builder.withDetail("maximumPoolSize", hikariDataSource.getMaximumPoolSize());
			HikariPoolMXBean hikariPoolMXBean = hikariDataSource.getHikariPoolMXBean();
			builder.withDetail("activeConnections", hikariPoolMXBean.getActiveConnections());
			builder.withDetail("idleConnections", hikariPoolMXBean.getIdleConnections());
			builder.withDetail("threadsAwaitingConnection", hikariPoolMXBean.getThreadsAwaitingConnection());
			builder.withDetail("totalConnections", hikariPoolMXBean.getTotalConnections());
		}
////////////////////////////////////////////////////////////////////////////////
////////////////////////////////////////////////////////////////////////////////
////////////////////////////////////////////////////////////////////////////////
