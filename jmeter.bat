...
setlocal
set "JVM_ARGS=%JVM_ARGS% -Dswing.plaf.metal.controlFont=D2Coding"
set "JVM_ARGS=%JVM_ARGS% -Dswing.plaf.metal.userFont=D2Coding"
rem "JVM_ARGS=%JVM_ARGS% -Dcom.ibm.mq.cfg.useIBMCipherMappings=false"
set "JVM_ARGS=%JVM_ARGS% -Dcom.ibm.msg.client.commonservices.log.outputName=System.out"
rem "JVM_ARGS=%JVM_ARGS% -Djavax.net.ssl.keyStore="
rem "JVM_ARGS=%JVM_ARGS% -Djavax.net.ssl.keyStorePassword="
...
if not defined JM_LAUNCH (
    set JM_LAUNCH=C:\Program Files\Java\jdk-17.0.12\bin\java.exe
)
